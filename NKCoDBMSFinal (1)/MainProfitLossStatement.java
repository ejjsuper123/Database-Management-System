...
public class MainProfitLossStatement extends javax.swing.JFrame {


    public MainProfitLossStatement() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        SearchBtn.setText("Search Profit-Loss Statement");
    ...
    private void AddBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddBtnActionPerformed
        AddProfitLossStatement ad = new AddProfitLossStatement();
        ad.setVisible(true);
    }//GEN-LAST:event_AddBtnActionPerformed

    private void SearchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchBtnActionPerformed
        SearchProfitLossStatement1 s = new SearchProfitLossStatement1();
        s.setVisible(true);
    }//GEN-LAST:event_SearchBtnActionPerformed

    private void UpdateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateBtnActionPerformed
        UpdateProfitLossStatement u = new UpdateProfitLossStatement();
        u.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainProfitLossStatement.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MainProfitLossStatement().setVisible(true);
            }
        });
    }
